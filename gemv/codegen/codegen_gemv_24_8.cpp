...
int main() {
  std::vector<std::vector<string>> ats{
    {"GEMV","IP", "Int8", "AVX512","24"},
    {"GEMV","IP", "Half", "AVX512","24"},
    {"GEMV","IP", "Float","AVX512","24"},
    {"GEMV","IP", "Half_Float", "AVX512","24"},

    {"GEMV","L2", "Int8", "AVX512","24"},
    {"GEMV","L2", "Half", "AVX512","24"},
    {"GEMV","L2", "Float","AVX512","24"},
    {"GEMV","L2", "Half_Float", "AVX512","24"},

    {"GEMV","IP", "Int8", "AVX256","8"},
    {"GEMV","IP", "Half", "AVX256","8"},
    {"GEMV","IP", "Half_Float","AVX256","8"},
    {"GEMV","IP", "Float","AVX256","8"},

    {"GEMV","L2", "Int8", "AVX256","8"},
    {"GEMV","L2", "Half", "AVX256","8"},
    {"GEMV","L2", "Half_Float","AVX256","8"},
    {"GEMV","L2", "Float","AVX256","8"},
  };
  ...
  //string hinfo = "struct GemvInfo{\ntypedef void (*GEMV)(void*);\n  static const std::map<std::string,std::vector<GEMV>> GemvPtr = {\n";
      ...
      if (line[3] == "AVX512") {
        ...
        if (line[2] == "Int8") {
          ...
          for (int m = 0; m < n; ++m) {
            ...
            if (line[1] == "IP") {
              addi(srcfile, "xorps xmm7,xmm7");
              addi(srcfile, "psubd xmm7,xmm6");
              addi(srcfile, "movss DWORD PTR [r11 + " + to_string(m * 4) + "],xmm7");
			  addi(srcfile, "cvtsi2ss xmm7,DWORD PTR [r11 + " + to_string(m * 4) + "]");
			  addi(srcfile, "movss DWORD PTR [r11 + " + to_string(m * 4) + "],xmm7");
            }
            else{
              addi(srcfile, "movss DWORD PTR [r11 + " + to_string(m * 4) + "],xmm6");
			  addi(srcfile, "cvtsi2ss xmm6,DWORD PTR [r11 + " + to_string(m * 4) + "]");
              addi(srcfile, "sqrtss xmm7,xmm6");
              addi(srcfile, "movss DWORD PTR [r11 + " + to_string(m * 4) + "],xmm7");
			}
            srcfile << std::endl;
          }
        ...
        /*
          ...
          for (int m = 0; m < n; ++m) {
            ...
            if (line[1] == "IP") {
              addi(srcfile, "xorps xmm7,xmm7");
              addi(srcfile, "subps xmm7,xmm6");
              addi(srcfile, "movss [r11 + " + to_string(m * 4) + "],xmm7");
            }
            else{
			  addi(srcfile, "sqrtss xmm7,xmm6");
              addi(srcfile, "movss [r11 + " + to_string(m * 4) + "],xmm7");
        ...
        if (line[2] == "Int8") {
          ...
          addi(srcfile, "lddqu xmm0,[r9 + rax]");
          addi(srcfile, "lddqu xmm1,[r9 + rax + 16]");
          addi(srcfile, "lddqu xmm2,[r9 + rax + 32]");
          addi(srcfile, "lddqu xmm3,[r9 + rax + 48]");
          addi(srcfile, "vpmovsxbw ymm4,xmm0");
          addi(srcfile, "vpmovsxbw ymm5,xmm1");
          addi(srcfile, "vpmovsxbw ymm6,xmm2");
          addi(srcfile, "vpmovsxbw ymm7,xmm3");
          srcfile << std::endl;
          ...
          for (int m = 0; m < n; ++m) {
            ...
            if (line[1] == "IP") {
              ...
              addi(srcfile, "lddqu xmm2,[r12 + rax + 32]");
              addi(srcfile, "lddqu xmm3,[r12 + rax + 48]");
              ...
              addi(srcfile, "vpmaddwd ymm2,ymm6,ymm2");
              addi(srcfile, "vpmaddwd ymm3,ymm7,ymm3");
              addi(srcfile, "vpaddd " + r_file[m] + "," + r_file[m] + ",ymm0");
              addi(srcfile, "vpaddd " + r_file[m] + "," + r_file[m] + ",ymm1");
              addi(srcfile, "vpaddd " + r_file[m] + "," + r_file[m] + ",ymm2");
              addi(srcfile, "vpaddd " + r_file[m] + "," + r_file[m] + ",ymm3");
            }
            else {
              addi(srcfile, "lddqu xmm0, [r12 + rax]");
              addi(srcfile, "lddqu xmm1, [r12 + rax + 16]");
              ...
              addi(srcfile, "vpsubw ymm2,ymm6,ymm2");
              addi(srcfile, "vpsubw ymm3,ymm7,ymm3");
              addi(srcfile, "vpmaddwd ymm0,ymm0,ymm0");
              addi(srcfile, "vpmaddwd ymm1,ymm1,ymm1");
              addi(srcfile, "vpmaddwd ymm2,ymm2,ymm2");
              addi(srcfile, "vpmaddwd ymm3,ymm3,ymm3");
              addi(srcfile, "vpaddd " + r_file[m] + "," + r_file[m] + ",ymm0");
              addi(srcfile, "vpaddd " + r_file[m] + "," + r_file[m] + ",ymm1");
              addi(srcfile, "vpaddd " + r_file[m] + "," + r_file[m] + ",ymm2");
              addi(srcfile, "vpaddd " + r_file[m] + "," + r_file[m] + ",ymm3");
          ...
          addi(srcfile, "prefetchnta [r13 + rax]");
          srcfile << "      //load vector and convert" << std::endl;
          addi(srcfile, "vcvtph2ps ymm4,XMMWORD PTR [r9 + rax]");
          addi(srcfile, "vcvtph2ps ymm5,XMMWORD PTR [r9 + rax + 16]");
          addi(srcfile, "vcvtph2ps ymm6,XMMWORD PTR [r9 + rax + 32]");
          addi(srcfile, "vcvtph2ps ymm7,XMMWORD PTR [r9 + rax + 48]");
          srcfile << std::endl;
          for (int m = 0; m < n; ++m) {
            addi(srcfile, "mov r12,r13");
            ...
            if (line[1] == "IP") {
              ...
              addi(srcfile, "vcvtph2ps ymm2,XMMWORD PTR  [r12 + rax + 32]");
              addi(srcfile, "vcvtph2ps ymm3,XMMWORD PTR  [r12 + rax + 48]");
              addi(srcfile, "vfmadd231ps " + r_file[m] + ",ymm4,ymm0");
              addi(srcfile, "vfmadd231ps " + r_file[m] + ",ymm5,ymm1");
              addi(srcfile, "vfmadd231ps " + r_file[m] + ",ymm6,ymm2");
              addi(srcfile, "vfmadd231ps " + r_file[m] + ",ymm7,ymm3");
            }
            else {
              addi(srcfile, "vcvtph2ps ymm0,XMMWORD PTR  [r12 + rax]");
              addi(srcfile, "vcvtph2ps ymm1,XMMWORD PTR  [r12 + rax + 16]");
              ...
              addi(srcfile, "vsubps ymm2,ymm6,ymm2");
              addi(srcfile, "vsubps ymm3,ymm7,ymm3");
              addi(srcfile, "vfmadd231ps " + r_file[m] + ",ymm0,ymm0");
              addi(srcfile, "vfmadd231ps " + r_file[m] + ",ymm1,ymm1");
              addi(srcfile, "vfmadd231ps " + r_file[m] + ",ymm2,ymm2");
              addi(srcfile, "vfmadd231ps " + r_file[m] + ",ymm3,ymm3");
            }
            srcfile << std::endl;
          }
          srcfile << "      //judge the loop" << std::endl;
          ...
          addi(srcfile, "prefetchnta [r13 + rax + 64]");
          srcfile << "      //load vector" << std::endl;
          addi(srcfile, "vmovaps ymm4,YMMWORD PTR [r9 + rax]");
          addi(srcfile, "vmovaps ymm5,YMMWORD PTR [r9 + rax + 32]");
          addi(srcfile, "vmovaps ymm6,YMMWORD PTR [r9 + rax + 64]");
          addi(srcfile, "vmovaps ymm7,YMMWORD PTR [r9 + rax + 96]");
          srcfile << std::endl;
          for (int m = 0; m < n; ++m) {
            addi(srcfile, "mov r12,r13");
            ...
            if (line[1] == "IP") {
              ...
              addi(srcfile, "vmovaps ymm2,YMMWORD PTR  [r12 + rax + 64]");
              addi(srcfile, "vmovaps ymm3,YMMWORD PTR  [r12 + rax + 96]");
              addi(srcfile, "vfmadd231ps " + r_file[m] + ",ymm4,ymm0");
              addi(srcfile, "vfmadd231ps " + r_file[m] + ",ymm5,ymm1");
              addi(srcfile, "vfmadd231ps " + r_file[m] + ",ymm6,ymm2");
              addi(srcfile, "vfmadd231ps " + r_file[m] + ",ymm7,ymm3");
          ...
          for (int m = 0; m < n; ++m) {
            ...
            if (line[1] == "IP") {
              ...
              addi(srcfile, "vcvtph2ps ymm2,XMMWORD PTR  [r12 + rbx + 32]");
              addi(srcfile, "vcvtph2ps ymm3,XMMWORD PTR  [r12 + rbx + 48]");
              addi(srcfile, "vfmadd231ps " + r_file[m] + ",ymm0,ymm4");
              addi(srcfile, "vfmadd231ps " + r_file[m] + ",ymm1,ymm5");
              addi(srcfile, "vfmadd231ps " + r_file[m] + ",ymm2,ymm6");
              addi(srcfile, "vfmadd231ps " + r_file[m] + ",ymm3,ymm7");
            }
            else {
              addi(srcfile, "vcvtph2ps ymm0,XMMWORD PTR  [r12 + rbx]");
              addi(srcfile, "vcvtph2ps ymm1,XMMWORD PTR  [r12 + rbx + 16]");
